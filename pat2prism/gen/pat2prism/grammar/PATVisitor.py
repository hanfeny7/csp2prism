...
class PATVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by PATParser#enumBody.
    def visitEnumBody(self, ctx:PATParser.EnumBodyContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by PATParser#initExpr.
    def visitInitExpr(self, ctx:PATParser.InitExprContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by PATParser#arrayInit.
    def visitArrayInit(self, ctx:PATParser.ArrayInitContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by PATParser#exprList.
    def visitExprList(self, ctx:PATParser.ExprListContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by PATParser#ifElseProcess.
    def visitIfElseProcess(self, ctx:PATParser.IfElseProcessContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by PATParser#msgExpr.
    def visitMsgExpr(self, ctx:PATParser.MsgExprContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by PATParser#codeStatement.
    def visitCodeStatement(self, ctx:PATParser.CodeStatementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by PATParser#ifStatement.
    def visitIfStatement(self, ctx:PATParser.IfStatementContext):
        return self.visitChildren(ctx)
