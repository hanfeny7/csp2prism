...
global EAP_Request_PSK_M1 : [0..7] init 0  // EAP_Request_PSK_M1, EAP_Response_PSK_M2, EAP_Request_PSK_M3...;
global PSK : [0..10000] init 1234;
global ID_P : [0..10000] init 1;
global ID_S : [0..10000] init 2;
global Fake_PSK : [0..10000] init 123;
...
global N_C : [0..1000] init 0  // var;
global N_P : [0..1000] init 0  // var;
global N_S : [0..1000] init 0  // var;
global AK : [0..1000] init 0  // var;
global MSK : [0..1000] init 0  // var;
global EMSK : [0..1000] init 0  // var;
global MAC_P : [0..1000] init 0  // var;
global MAC_S : [0..1000] init 0  // var;
global PCHANNEL : [0..1000] init 0  // var;
global AUTH : [0..1000] init 0  // var;
global expected_AUTH : [0..1000] init 0  // var;
...
global EAP_Request_PSK_M1_N_S_1 : [0..10000] init 0  // nonce field;
global EAP_Request_PSK_M1_ID_S : [0..100] init 0  // ID field;
global EAP_Response_PSK_M2_MAC_P_1 : [0..1000] init 0  // MAC field;
global EAP_Response_PSK_M2_MAC_P : [0..1000] init 0  // MAC field;
global EAP_Request_PSK_M3_MAC_S : [0..1000] init 0  // MAC field;
global EAP_Request_PSK_M3_MAC_S_1 : [0..1000] init 0  // MAC field;
global EAP_Request_PSK_M3_PCHANNEL : [0..1000] init 0  // message field;
global EAP_Request_PSK_M3_PCHANNEL_1 : [0..1000] init 0  // message field;
global EAP_Success_MSK_1 : [0..1000] init 0  // message field;
...
module SmartObject
  ...
  [sync_ComSC_EAP_Request_PSK_M1] s_SmartObject=2 ->
    (N_S_1' = EAP_Request_PSK_M1_N_S_1) &
  ...
  [sync_ComSC_EAP_Request_PSK_M3] s_SmartObject=6 ->
    (MAC_S_1' = EAP_Request_PSK_M3_MAC_S_1) &
    (PCHANNEL_1' = EAP_Request_PSK_M3_PCHANNEL_1) &
...
// Process: AUTH_1
module AUTH_1
  // State variable for AUTH_1
  s_AUTH_1 : [0..0] init 0;

  // Terminal state (self-loop)
  [] s_AUTH_1=0 -> (s_AUTH_1' = 0);
...
module Controller
  ...
  [sync_ComSC_EAP_Response_PSK_M2] s_Controller=4 ->
    (MAC_P_1' = EAP_Response_PSK_M2_MAC_P_1) &
    (chan_ComSC' = MSG_EAP_Response_PSK_M2) &
    (s_Controller' = 5);
