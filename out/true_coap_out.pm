...
// ===== Global Variables =====
global chan_ComSC : [0..3] init 0;
global chan_ComCA : [0..3] init 0;
global ANON_ENUM : [0..10] init 0;
global PSK : 1234;
global random_var : [101,1011,1001,1101];
global N_C : int init 0;
global N_P : int init 0;
global N_S : int init 0;
global AK : int init 0;
global MSK : int init 0;
global EMSK : int init 0;
global MAC_P_expected : int init 0;
global MAC_S_expected : int init 0;
global rec_MAC_P : int init 0;
global rec_MAC_S : int init 0;
